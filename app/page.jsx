        ...
        <section id="hero" className={styles.hero}>
          <div className={styles.heroContent}>
            ...
            <p className={styles.heroText}>
              Join a community of passionate developers and bring your app ideas to life!
            </p>
          ...
          <div className={styles.sectionContent}>
            ...
            <div className={styles.aboutContent}>
              ...
              <div className={styles.aboutText}>
                <p>
                  The UB App Dev Club is a student-run organization dedicated to fostering app development skills and
                  creativity among University at Buffalo students. We provide a collaborative environment where members
                  can learn, share ideas, and work on exciting projects together.
                </p>
                <p>
                  Whether you're a beginner or an experienced developer, our club offers opportunities to enhance your
                  skills, network with like-minded individuals, and stay up-to-date with the latest trends in app
                  development.
                </p>
              </div>
            </div>
          ...
          <div className={styles.sectionContent}>
            ...
            <div className={styles.benefitsGrid}>
              <div className={styles.benefitCard}>
                ...
                <p>
                  Participate in regular workshops covering various aspects of app development, from UI/UX design to
                  backend integration.
                </p>
              </div>
              <div className={styles.benefitCard}>
                ...
                <p>
                  Connect with fellow students, alumni, and industry professionals who share your passion for app
                  development.
                </p>
              </div>
              <div className={styles.benefitCard}>
